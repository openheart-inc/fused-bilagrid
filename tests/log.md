...
```md
**Max absolute difference with PyTorch:
#e-10/11 for grad and #e-5/6 for output**

# Profile sample

torch forward: 4.99 ms
fused forward: 0.45 ms

torch backward: 18.84 ms
fused backward: 7.17 ms
fused backward with coords.grad: 7.25 ms

# Profile uniform sample

torch forward: 5.01 ms
fused forward: 0.42 ms

torch backward: 20.11 ms

**the only thing that's heavily optimized**
fused backward: 8.69 ms  **v1**
fused backward: 4.57 ms  **v2, new default**
```
